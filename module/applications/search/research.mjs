...
export class SearchChat {
  ...
  constructor() {
    ...
    this.template = `systems/${SYSTEM.id}/templates/search/searchResult.hbs`;
  }
...
export class SearchDialog extends Dialog {
  ...
  data = {
    title: game.i18n.localize("MAGNA.SEARCHTOOL.window_title"),
    buttons: {
      chercher: {
        label: game.i18n.localize("MAGNA.SEARCHTOOL.button_search"),
        callback: async (html) => {
      ...
      cancel: {
        ...
        label: game.i18n.localize("MAGNA.SEARCHTOOL.button_cancel"),
        callback: () => {},
      },
    },
    default: "chercher",
